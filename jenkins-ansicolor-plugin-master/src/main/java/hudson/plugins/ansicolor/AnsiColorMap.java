...
public final class AnsiColorMap implements Serializable {
	...
	public static final AnsiColorMap XTerm = new AnsiColorMap("xterm", "#000000", "#CD0000", "#00CD00", "#CDCD00",
			"#1E90FF", "#CD00CD", "#00CDCD", "#E5E5E5", "#4C4C4C", "#FF0000", "#00FF00", "#FFFF00", "#4682B4",
			"#FF00FF", "#00FFFF", "#FFFFFF", null, null);

	public static final AnsiColorMap VGA = new AnsiColorMap("vga", "#000000", "#AA0000", "#00AA00", "#AA5500",
			"#0000AA", "#AA00AA", "#00AAAA", "#AAAAAA", "#555555", "#FF5555", "#55FF55", "#FFFF55", "#5555FF",
			"#FF55FF", "#55FFFF", "#FFFFFF", Color.WHITE.ordinal(), Color.BLACK.ordinal());

	public static final AnsiColorMap CSS = new AnsiColorMap("css", "black", "red", "green", "yellow", "blue", "magenta",
			"cyan", "white", "black", "red", "green", "yellow", "blue", "magenta", "cyan", "white", null, null);

	public static final AnsiColorMap GnomeTerminal = new AnsiColorMap("gnome-terminal", "#2E3436", "#CC0000", "#4E9A06",
			"#C4A000", "#3465A4", "#75507B", "#06989A", "#D3D7CF", "#2E3436", "#CC0000", "#4E9A06", "#C4A000",
			"#3465A4", "#75507B", "#06989A", "#D3D7CF", Color.WHITE.ordinal(), Color.BLACK.ordinal());
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(41, 89).append(name).append(normalMap).append(brightMap).append(defaultForeground)
				.append(defaultBackground).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(name, ansiColorMap.name).append(normalMap, ansiColorMap.normalMap)
				.append(brightMap, ansiColorMap.brightMap).append(defaultForeground, ansiColorMap.defaultForeground)
				.append(defaultBackground, ansiColorMap.defaultBackground).isEquals();
	}

	// Those are nullable to not impose any default color on the output.
	@DataBoundConstructor
	public AnsiColorMap(String name, String black, String red, String green, String yellow, String blue, String magenta,
			String cyan, String white, String blackB, String redB, String greenB, String yellowB, String blueB,
			String magentaB, String cyanB, String whiteB, Integer defaultForeground, Integer defaultBackground) {
		this.name = name;
